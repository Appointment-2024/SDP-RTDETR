...
class HGStem(nn.Module):
    ...
    def __init__(self, c1, cm, c2):
        ...
        self.stem3 = nn.Sequential(
            Conv(cm * 2, cm * 2, 3, 2, 1, g=cm * 2, act=nn.ReLU()),  # depthwise 3x3/s2
            Conv(cm * 2, cm, 1, 1, 0, g=1, act=nn.ReLU()),  # pointwise 1x1
        ) # pointwise # pointwise 1x1  # --- 关键改动：把原来的标准Conv(2*cm -> cm, 3x3, s=2) 改成 DW3x3/s2 + PW1x1 ---
        # 原来： self.stem3 = Conv(cm * 2, cm, 3, 2, act=nn.ReLU())
